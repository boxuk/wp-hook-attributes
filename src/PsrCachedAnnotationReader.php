...
/**
 * A cache aware annotation reader. Added here until https://github.com/doctrine/annotations/pull/424 is merged.
 * @codeCoverageIgnore
 */
final class PsrCachedAnnotationReader implements Reader
{
    /** @var Reader */
    private $delegate;
