...
function action_with_priority(): string
{
 ...
 */
#[Action('init', args: 2)]
function action_with_args(int $a, int $b): string
{
...
function filter_with_priority(): string
{
...
function filter_with_args(int $a, int $b): string
{
